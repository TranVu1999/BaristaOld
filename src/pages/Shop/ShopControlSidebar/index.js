...
export default class ShopControlSidebar extends Component {
    onHanldeSidebarControl = () =>{
        this.props.onHanldeSidebarControl(true)
    }
    render() {
        return (
            <button 
                className="control-sidebar"
                onClick = {this.onHanldeSidebarControl}
            >
